    ...
    return (
        <div className="container">
            ...
            <div className="flex flex-col lg:flex-row justify-center lg:items-center gap-10">
                <div className="left w-full lg:w-1/2 flex flex-col gap-5 items-center">
                    <div className="flex flex-row gap-2">
                        <div>
                            <img loading="lazy" className="pointer-events-none max-w-full md:w-8 w-20 md:h-8 h-20" src={sheet} alt="sheet-icon" />
                        </div>
                        <div>
                            <p>
                                ...
                                Facile à éditer sur tous les Systèmes (Windows er Mac) et parfait pour tous types de
                                candidatures.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-row gap-2">
                        <div>
                            <img loading="lazy" className="pointer-events-none max-w-full md:w-8 w-20 md:h-8 h-20" src={pen} alt="pen-icon" />
                        </div>
                        <div>
                            <p>
                                <span className="text-blue-500 font-bold">
                    ...
                    <div className="flex flex-row gap-2">
                        <div>
                            <img loading="lazy" className="pointer-events-none max-w-full md:w-8 w-20 md:h-8 h-20" src={question} alt="question-icon" />
                        </div>
                        <div>
                            <p>
                                <span className="text-blue-500 font-bold">
                    ...
                    <div className="flex flex-row gap-2">
                        <div>
                            <img loading="lazy" className="pointer-events-none max-w-full md:w-8 w-20 md:h-8 h-20" src={card} alt="card-icon" />
                        </div>
                        <div>
                            <p>
                                <span className="text-blue-500 font-bold">
