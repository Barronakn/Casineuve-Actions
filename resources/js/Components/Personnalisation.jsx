...
const Personnalisation = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "Trouvez des vidéos tutorielles pour utiliser le modèle au format PPT dans PowerPoint.",
        },
        {
            tag: "Guide Microsoft Word Tutoriel Vidéo",
            answer: "Trouvez des vidéos tutorielles pour utiliser le modèle au format PPT dans Word.",
        },
    ];
            ...
            <div>
                {faqs.map((faq, index) => (
                    <div
                        ...
                        className="flex text-lg sm:text-xl md:text-2xl cursor-pointer flex-col gap-3 p-5 rounded-lg shadow-md bg-white my-5"
                    >
