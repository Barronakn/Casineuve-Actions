      ...
      <div className="mx-10 md:mx-20 lg:mx-32">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-4xl font-bold my-8 text-center">
            Plus de 2 000 Professionnels recommandent Casineuve Actions
          </h1>
          <div className="flex flex-col gap-4 container text-center">
            <p>
              Depuis 2022, chez Casineuve Actions, nous avons eu le privilège
              d'accompagner plus de 1000 candidats dans le montage de leur
              dossier de candidature.
            </p>
            <p>
              Aussi, nos modèles ont été le choix judicieux de centaines de
              candidats, les propulsant vers de nouveaux horizons professionnels
              et débloquant des portes jusqu'alors fermées.
            </p>
          </div>
          <div>
            ...
            <p className="text-center">
              Vos avis sont la boussole qui guide notre quête d'excellence. Sur
              notre Page{" "}
              <a
              ...
              , nous collectons vos retours pour comprendre comment nous pouvons
              continuer à vous accompagner de manière toujours plus efficace.
            </p>
          </div>
        </div>
        <div>
          ...
          <p className="my-8 text-center">
            Rejoignez notre communauté de professionnels qui ont fait confiance
            à Casineuve Actions. Nos clients travaillent aujourd'hui dans des
            entreprises renommées. Leur succès atteste de l'efficacité de notre
            collaboration.
          </p>
          <img
            loading="lazy"
