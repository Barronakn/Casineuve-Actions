      ...
      <div className="flex flex-col justify-center items-center mt-20 md:mt-40 mx-10 sm:mx-20 lg:mx-32">
        <div>
          ...
          <p className="text-center text-base md:text-xl my-14">
            Envisagez une candidature irrésistible avec notre expertise.
            Laissez-nous créer pour vous un CV percutant et une lettre de
            motivation qui capte l'essence de votre parcours et ambitions. Notre
            équipe est à votre écoute pour personnaliser chaque élément de votre
            dossier selon vos aspirations.
          </p>
        </div>
        <div>
          <img
        ...
        <div>
          <p className="text-center text-base md:text-xl my-10">
            Contactez-nous par mail ou WhatsApp pour une consultation initiale,
            où nous discuterons ensemble de vos objectifs et tracerons le chemin
            vers votre succès
          </p>
