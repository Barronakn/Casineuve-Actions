    ...
    return (
        <div>
            ...
            <p className="text-lg lg:text-3xl text-justify mx-10 md:mx-20 lg:mx-32">
                <span className="font-bold">Réponses à Vos Questions |</span> Découvrez ci-dessous les réponses aux
                questions fréquemment posées, organisées par thématiques pour
